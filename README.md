...
full rebuilds and ensure fresh data when needed. Each plan also writes the
dependency graph to `build/dag.mmd` as a [Mermaid](https://mermaid.js.org) flowchart; `make -s dag` prints it.
